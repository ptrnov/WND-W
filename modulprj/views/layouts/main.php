...
use modulprj\models\system\side_menu\M1000;			/* TABLE CLASS */

//AppAsset::register($this);
dmstr\web\AdminLteAsset::register($this);
$this->title = Yii::t('app', 'www.wanindoprima.co.id');
?>
<?php $this->beginPage() ?>
	<!DOCTYPE html>
		...
		<?php
			...
			*/
			...
			if (!Yii::$app->user->isGuest) {
				...
				$MainUserProfile = $ModelUserAttr->emp->KAR_NM;
			
			}
			$corp="<p class='pull-left'>&copy; ptr.nov <?= date('Y') ?></p>";
		?>
                                    ...
                                    $menuItemsNoLogin[] = [
										'label' => Icon::show('shopping-cart') .'e-Procurement', 'url' => ['/site/loginc'],
											'items' => [
                                                ...
                                                '<li><a data-toggle="modal_login" data-target="#1" style="cursor: pointer;">Click me gently!</a></li>',
											],
									];
                                    */
